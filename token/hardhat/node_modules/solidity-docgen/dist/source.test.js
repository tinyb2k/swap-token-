...
(0, ava_1.default)('one empty file', t => {
    const solcOutput = new solc_output_builder_1.SolcOutputBuilder()
        .file('Foo.sol');
    const source = buildSource(solcOutput);
    t.is(source.files.length, 1);
});
(0, ava_1.default)('one contract', t => {
    const solcOutput = new solc_output_builder_1.SolcOutputBuilder()
        .file('Foo.sol')
        .contract('Foo');
    const source = buildSource(solcOutput);
...
(0, ava_1.default)('one own function', t => {
    const solcOutput = new solc_output_builder_1.SolcOutputBuilder()
        .file('Foo.sol')
        .contract('Foo')
        .function('test');
...
(0, ava_1.default)('one inherited function', t => {
    const solcOutput = new solc_output_builder_1.SolcOutputBuilder()
        .file('Foo.sol')
        .contract('Foo')
        .function('test')
...
(0, ava_1.default)('one multiply inherited function', t => {
    const solcOutput = new solc_output_builder_1.SolcOutputBuilder()
        .file('Foo.sol')
        .contract('Foo')
        .function('test')
...
(0, ava_1.default)('two inherited functions with name overloading', t => {
    const solcOutput = new solc_output_builder_1.SolcOutputBuilder()
        .file('Foo.sol')
        .contract('Foo')
...
(0, ava_1.default)('grouped inherited items', t => {
    const solcOutput = new solc_output_builder_1.SolcOutputBuilder()
        .file('Foo.sol')
        .contract('Foo')
        .function('foo-test')
...
(0, ava_1.default)('two inherited constructors', t => {
    const solcOutput = new solc_output_builder_1.SolcOutputBuilder()
        .file('Foo.sol')
        .contract('Foo')
...
(0, ava_1.default)('a state variable', t => {
    const solcOutput = new solc_output_builder_1.SolcOutputBuilder()
        .file('Foo.sol')
        .contract('Foo')
        .variable('x', 'uint256');
...
(0, ava_1.default)('an inherited state variable', t => {
    const solcOutput = new solc_output_builder_1.SolcOutputBuilder()
        .file('Foo.sol')
        .contract('Foo')
        .variable('x', 'uint256')
...
(0, ava_1.default)('contracts in scope from imported files', t => {
    const solcOutput = new solc_output_builder_1.SolcOutputBuilder()
        .file('Foo.sol')
        .contract('Foo')
        .file('Bar.sol')
...
(0, ava_1.default)('contracts in scope from imported files with alias', t => {
    const solcOutput = new solc_output_builder_1.SolcOutputBuilder()
        .file('Foo.sol')
        .contract('Foo')
        .file('Bar.sol')
...
(0, ava_1.default)('contracts in scope from imported files transitively', t => {
    const solcOutput = new solc_output_builder_1.SolcOutputBuilder()
        .file('Foo.sol')
        .contract('Foo')
        .file('Bar.sol')
...
(0, ava_1.default)('using real compiler output (0.6)', async (t) => {
  ...
  `;
    const solcOutput = await (0, solc_fork_1.solcCompile)('solc', {
        language: 'Solidity',
        sources: {
            test: {
                content: sourceText,
