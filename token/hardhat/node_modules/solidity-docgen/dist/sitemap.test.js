...
(0, ava_1.default)('single readme', t => {
...
(0, ava_1.default)('single readme no contracts', t => {
...
(0, ava_1.default)('single readme multiple contracts', t => {
    const source = buildSoliditySource(b => b
        .file('Foo.sol')
        .contract('Foo')
        .contract('Bar'));
...
(0, ava_1.default)('single source with file multiple contracts', t => {
    const source = buildSoliditySource(b => b
        .file('test.sol')
        .contract('Foo')
        .contract('Bar'));
...
(0, ava_1.default)('filter subdirectory', t => {
    const source = buildSoliditySource(b => b
        .file('Foo.sol')
        .contract('Foo')
        .file('sub/Bar.sol')
...
(0, ava_1.default)('filter nested subdirectories', t => {
    const source = buildSoliditySource(b => b
        .file('sub/Bar.sol')
        .contract('Bar')
