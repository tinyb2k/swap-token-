...
async function smokeTest(t, solcModule, version) {
    ...
    const output = await (0, solc_fork_1.solcCompile)(solcModule, input);
    t.is('object', typeof output);
    t.is(undefined, output.errors);
}
(0, ava_1.default)('smoke test 0.8', async (t) => {
    await smokeTest(t, 'solc-0-8', '0.8');
});
(0, ava_1.default)('smoke test 0.7', async (t) => {
    await smokeTest(t, 'solc-0-7', '0.7');
});
(0, ava_1.default)('smoke test 0.6', async (t) => {
    await smokeTest(t, 'solc', '0.6');
});
(0, ava_1.default)('smoke test 0.5', async (t) => {
    await smokeTest(t, 'solc-0-5', '0.5');
});
(0, ava_1.default)('smoke test 0.4', async (t) => {
